// src/app/components/defect-panel/defect-panel.ts
...
@Component({
  selector: 'app-defect-panel',
  imports: [CommonModule, FormsModule, MatIconModule, MatTooltipModule],
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `
    <div class="panel-container">
      <div class="panel-header">
        <span class="panel-title">Submit Defect</span>
      ...
      <div class="form-area">
        @if (submitted()) {
          <div class="success-state">
            ...
            <p class="success-text">Defect #{{ ticketId() }} submitted successfully!</p>
          ...
          <div class="form-group readonly-group">
            <div class="readonly-row">
              <span class="readonly-label">Tag:</span>
              <span class="readonly-value">Defect</span>
            </div>
            <div class="readonly-row">
              <span class="readonly-label">Type:</span>
              <span class="readonly-value">Problem</span>
            </div>
            <div class="readonly-row">
            ...
            <div class="readonly-row">
              <span class="readonly-label">Priority:</span>
              <span class="readonly-value">Medium</span>
            </div>
            <div class="readonly-row">
              <span class="readonly-label">Agent:</span>
...
export class DefectPanelComponent {
  ...
  async submitDefect(): Promise<void> {
    ...
    try {
      ...
      this.notificationService.show('Defect submitted', 'success');
    } catch {
      this.notificationService.show('Failed to submit defect', 'error');
    } finally {
  ...
  close(): void {
    this.tabService.closeTab('defect');
  }
}
